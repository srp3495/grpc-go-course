...
type PrimeDecompositionStreamRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *PrimeDecompositionStreamRequest) Reset() {
	*x = PrimeDecompositionStreamRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *PrimeDecompositionStreamRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PrimeDecompositionStreamRequest) ProtoMessage() {}

func (x *PrimeDecompositionStreamRequest) ProtoReflect() protoreflect.Message {
	mi := &file_calculator_calculatorpb_calculator_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PrimeDecompositionStreamRequest.ProtoReflect.Descriptor instead.
func (*PrimeDecompositionStreamRequest) Descriptor() ([]byte, []int) {
	return file_calculator_calculatorpb_calculator_proto_rawDescGZIP(), []int{2}
}

func (x *PrimeDecompositionStreamRequest) GetValue() int64 {
	if x != nil {
		return x.Value
	}
	return 0
...
type PrimeDecompositionStreamResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *PrimeDecompositionStreamResponse) Reset() {
	*x = PrimeDecompositionStreamResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *PrimeDecompositionStreamResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PrimeDecompositionStreamResponse) ProtoMessage() {}

func (x *PrimeDecompositionStreamResponse) ProtoReflect() protoreflect.Message {
	mi := &file_calculator_calculatorpb_calculator_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PrimeDecompositionStreamResponse.ProtoReflect.Descriptor instead.
func (*PrimeDecompositionStreamResponse) Descriptor() ([]byte, []int) {
	return file_calculator_calculatorpb_calculator_proto_rawDescGZIP(), []int{3}
}

func (x *PrimeDecompositionStreamResponse) GetResult() int64 {
	if x != nil {
		return x.Result
	}
	return 0
...
func (x *ComputeAverageRequest) GetValue() int64 {
	if x != nil {
		return x.Value
	}
	return 0
...
var file_calculator_calculatorpb_calculator_proto_rawDesc = []byte{
	...
	0x75, 0x6c, 0x61, 0x74, 0x6f, 0x72, 0x22, 0x46, 0x0a, 0x0a, 0x53, 0x75, 0x6d, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x12, 0x1a, 0x0a, 0x08, 0x46, 0x69, 0x72, 0x73, 0x74, 0x4e, 0x75, 0x6d,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x08, 0x46, 0x69, 0x72, 0x73, 0x74, 0x4e, 0x75, 0x6d,
	0x12, 0x1c, 0x0a, 0x09, 0x53, 0x65, 0x63, 0x6f, 0x6e, 0x64, 0x4e, 0x75, 0x6d, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x05, 0x52, 0x09, 0x53, 0x65, 0x63, 0x6f, 0x6e, 0x64, 0x4e, 0x75, 0x6d, 0x22, 0x25,
	...
	0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x37, 0x0a, 0x1f, 0x50, 0x72, 0x69, 0x6d, 0x65, 0x44, 0x65,
	0x63, 0x6f, 0x6d, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x74, 0x72, 0x65, 0x61,
	0x6d, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x56, 0x61, 0x6c, 0x75,
	0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x3a,
	0x0a, 0x20, 0x50, 0x72, 0x69, 0x6d, 0x65, 0x44, 0x65, 0x63, 0x6f, 0x6d, 0x70, 0x6f, 0x73, 0x69,
	...
	0x28, 0x03, 0x52, 0x06, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x2d, 0x0a, 0x15, 0x43, 0x6f,
	...
	0x28, 0x03, 0x52, 0x05, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x30, 0x0a, 0x16, 0x43, 0x6f, 0x6d,
	...
	0x01, 0x28, 0x02, 0x52, 0x06, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x22, 0x0a, 0x0a, 0x4d,
	0x61, 0x78, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x56, 0x61, 0x6c,
	...
	0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x25, 0x0a, 0x0b, 0x53, 0x71, 0x72, 0x74, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x06, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x22, 0x26, 0x0a,
	0x0c, 0x53, 0x71, 0x72, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x16, 0x0a,
	0x06, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x06, 0x52,
	0x65, 0x73, 0x75, 0x6c, 0x74, 0x32, 0xaa, 0x03, 0x0a, 0x11, 0x63, 0x61, 0x6c, 0x63, 0x75, 0x6c,
	...
	0x6e, 0x73, 0x65, 0x12, 0x79, 0x0a, 0x18, 0x50, 0x72, 0x69, 0x6d, 0x65, 0x44, 0x65, 0x63, 0x6f,
	...
	0x6d, 0x65, 0x44, 0x65, 0x63, 0x6f, 0x6d, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x53,
	...
	0x65, 0x63, 0x6f, 0x6d, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x74, 0x72, 0x65,
	0x61, 0x6d, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x30, 0x01, 0x12, 0x5b,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x28, 0x01, 0x12, 0x42, 0x0a, 0x0b, 0x53,
	0x65, 0x6e, 0x64, 0x4d, 0x61, 0x78, 0x69, 0x6d, 0x75, 0x6d, 0x12, 0x16, 0x2e, 0x63, 0x61, 0x6c,
...
var file_calculator_calculatorpb_calculator_proto_goTypes = []interface{}{
	...
	(*PrimeDecompositionStreamRequest)(nil),  // 2: calculator.PrimeDecompositionStreamRequest
	(*PrimeDecompositionStreamResponse)(nil), // 3: calculator.PrimeDecompositionStreamResponse
...
var file_calculator_calculatorpb_calculator_proto_depIdxs = []int32{
	...
	2, // 1: calculator.calculatorService.PrimeDecompositionStream:input_type -> calculator.PrimeDecompositionStreamRequest
	4, // 2: calculator.calculatorService.ComputeAverage:input_type -> calculator.ComputeAverageRequest
	6, // 3: calculator.calculatorService.SendMaximum:input_type -> calculator.MaxRequest
	...
	3, // 6: calculator.calculatorService.PrimeDecompositionStream:output_type -> calculator.PrimeDecompositionStreamResponse
	5, // 7: calculator.calculatorService.ComputeAverage:output_type -> calculator.ComputeAverageResponse
	7, // 8: calculator.calculatorService.SendMaximum:output_type -> calculator.MaxResponse
...
func file_calculator_calculatorpb_calculator_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_calculator_calculatorpb_calculator_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PrimeDecompositionStreamRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_calculator_calculatorpb_calculator_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PrimeDecompositionStreamResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
