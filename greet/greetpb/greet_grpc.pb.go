...
type GreetServiceClient interface {
	...
	//server streaming
	GreetManyTimes(ctx context.Context, in *GreeetManyRequest, opts ...grpc.CallOption) (GreetService_GreetManyTimesClient, error)
	//client streaming
	...
	//unaryWithDeadLine
	GreetWithDeadline(ctx context.Context, in *DeadLineGreetRequest, opts ...grpc.CallOption) (*DeadLineGreetResponse, error)
}
...
func (c *greetServiceClient) GreetManyTimes(ctx context.Context, in *GreeetManyRequest, opts ...grpc.CallOption) (GreetService_GreetManyTimesClient, error) {
...
func (x *greetServiceGreetManyTimesClient) Recv() (*GreeetManyResponse, error) {
	m := new(GreeetManyResponse)
...
func (c *greetServiceClient) GreetWithDeadline(ctx context.Context, in *DeadLineGreetRequest, opts ...grpc.CallOption) (*DeadLineGreetResponse, error) {
	out := new(DeadLineGreetResponse)
...
type GreetServiceServer interface {
	...
	//server streaming
	GreetManyTimes(*GreeetManyRequest, GreetService_GreetManyTimesServer) error
	//client streaming
	LongGreet(GreetService_LongGreetServer) error
	//Bidirectional
	GreetEveryOne(GreetService_GreetEveryOneServer) error
	//unaryWithDeadLine
	GreetWithDeadline(context.Context, *DeadLineGreetRequest) (*DeadLineGreetResponse, error)
...
func (UnimplementedGreetServiceServer) GreetManyTimes(*GreeetManyRequest, GreetService_GreetManyTimesServer) error {
...
func (UnimplementedGreetServiceServer) GreetWithDeadline(context.Context, *DeadLineGreetRequest) (*DeadLineGreetResponse, error) {
...
func (x *greetServiceGreetManyTimesServer) Send(m *GreeetManyResponse) error {
...
func _GreetService_GreetWithDeadline_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreetServiceServer).GreetWithDeadline(ctx, req.(*DeadLineGreetRequest))
	}
	return interceptor(ctx, in, info, handler)
}
